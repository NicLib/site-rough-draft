<nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <a href="#" style="font-size:.75em;"><em>open 7:45am - Midnight</em></a>
        ...
        <ul class="nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    ...
                    <a class="dropdown-item" href="ill.php">Interlibrary Loan</a>
                    <a class="dropdown-item" href="https://libguides.anderson.edu/az.php" target="_blank">Research Help</a>
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Community Information</a>
            </li>
            <li class="nav-item dropdown">
